...
class Vol{
    ...
    public Vol(int numeroVol, String origine, String destination, String dateHeureDepart, String dateHeureArrivee, boolean etat, String aeroportDepart, String aeroportArriver){
